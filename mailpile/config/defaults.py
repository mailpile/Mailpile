...
CONFIG_RULES = {
    ...
    'prefs': p(_("User preferences"), False, {
        ...
        'encrypt_vcards': X(_('Encrypt the contact database'), bool,    False),
        'encrypt_events': X(_('Encrypt the event log'), bool,           False),
        'encrypt_misc':   X(_('Encrypt misc. local data'), bool,        False),
