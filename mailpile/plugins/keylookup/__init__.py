...
class KeychainLookupHandler(LookupHandler):
    ...
    def _getkey(self, key):
        # This is a kludge to return a dict that looks like the one returned
        # by KeyserverLookupHandler._getkey() and
        # EmailKeyLookupHandler._getkey() which is actually generated by
        # GnuPG._parse_import(). Those return values may have dict keys
        # 'created', 'validity', 'keytype_name' which may be absent from
        # the dict returned here.
