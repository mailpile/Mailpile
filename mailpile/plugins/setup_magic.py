...
#       },
    ...
    def basic_app_config(self, session,
        ...
        # Added list of regex of trusted URLs of comman file sharing sites 
        trusted_attachment_urls=['/^((https|http):\/\/)?(www.)?dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/content_link\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/content_link_zip\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/content_link_htmlify\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/content_link_preview\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/link_token_dl\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/link_token_dl_zip\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/zip_collection\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?,(www.)?[a-z0-9]\.dropbox.com\/transcode_video\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/t\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com/u\/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/s\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/sh\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/sc\/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photos\/album\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photo\s/c\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photos\/cc\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photos\/c/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photos/cp/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.dropbox.com\/photos\/post\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl.dropboxusercontent.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl-web.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl-client.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl-doc.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?dl-doc.dropboxusercontent.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?api-content.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?content.dropboxapi.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?api-content-photos.dropbox.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?docs.google.com\/document\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?docs.google.com\/spreadsheets\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?docs.google.com\/presentation\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?docs.google.com\/forms\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?drive.google.com\/file\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?1drv.ms\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.files.1drv.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.onedrive.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.[a-z0-9]\.onedrive.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?storage.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.storage.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.[a-z0-9]\.storage.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.groups.office.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.groups.photos.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.groups.skydrive.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?photos.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?skydrive.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?api.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?apis.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?docs.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?skyapi.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?storage.msn.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.docs.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.policies.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.livefilestore.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.[a-z0-9]\.livefilestore.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.storage.msn.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.[a-z0-9]\.storage.msn.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?snapi.live.net\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?onedrive.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?[a-z0-9]\.onedrive.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            '/^((https|http):\/\/)?(www.)?onedrive.live.com\/(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/',
            ]

        session.config.prefs.attachment_urls = trusted_attachment_urls
