...
Mailpile.silly_strings = {
  ...
  nerds: [
    ...
    '{{_("Syntax error in line 45 of this email")|escapejs}}',
  ...
  email: [
    ...
    '{{_("I am pretty sure email from ThinkGeeks 2011 X-mas sale can be deleted.")|escapejs}}',
    '{{_("Do you really need an email to know when you have been retweeted?")|escapejs}}',
    '{{_("Email is the largest internet based social network on the planet")|escapejs}}',
    '{{_("Which other technology do you use that is 40 years old?")|escapejs}}',
    '{{_("There are 2.5 billion email users worldwide, thats double the amount of Facebook users!")|escapejs}}',
    '{{_("Use Mailpile Tags to better organize and search your mail")|escapejs}}',
    '{{_("Remember getting your first email address? Remember how it felt like something private?")|escapejs}}',
    '{{_("Email is a decentralized by design, this means no one company or government owns it!")|escapejs}}',
    '{{_("Over 100 trillion emails are sent per year, wow!")|escapejs}}',
    '{{_("Email is the most widely used communication protocol ever created by humans")|escapejs}}',
    '{{_("Email uses an open standard agreed upon by the entire world & owned by no one")|escapejs}}'
  ],
  security: [
    '{{_("BCC-ing ALL THE SPIES!")|escapejs}}',
    '{{_("Many powerful governments are conducting mass dragnet surveillance")|escapejs}}',
    '{{_("Most email can be read by network operators as it travels through the internet")|escapejs}}',
    '{{_("Encryption ensures that your emails are only read by the intended recipient")|escapejs}}',
    '{{_("Unencrypted email is more like sending a postcard than sending a letter")|escapejs}}',
    ...
    '{{_("Encrypting emails means your communication actually stays private")|escapejs}}',
    '{{_("The more encrypted email you send, the better!")|escapejs}}',
    ...
    '{{_("The most common email password is 123456, hopefully yours is different")|escapejs}}'
  ],
  misc: [
    ...
    '{{_("Oh, you have some very interesting old emails")|escapejs}}',
    '{{_("I think I better understand you now")|escapejs}}',
    '{{_("Your past is just a story you tell yourself")|escapejs}}',
    '{{_("Checking emails for stolen Winklevoss ideas")|escapejs}}',
