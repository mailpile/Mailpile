...
Mailpile = {
  ...
  keybindings:        [
    ...
    { title: '{{_("View settings")|escapejs}}',       keys: "g s",     callback: function() { Mailpile.go("/settings/profiles/"); }},
    { title: '{{_("Open thread")|escapejs}}',         keys: "enter",   callback: function() { Mailpile.open_selected_thread(); }},
    ...
    { title: '{{_("Move selection down")|escapejs}}', keys: "j",       callback: function() { Mailpile.bulk_action_selection_down(); }},
    { title: '{{_("Move selection up")|escapejs}}',   keys: "k",       callback: function() { Mailpile.bulk_action_selection_up(); }},
