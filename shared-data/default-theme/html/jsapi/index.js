...
Mailpile = {
  ...
  contacts_cache:     [],
  keybindings:        [
    { title: "Search mail",         keys: "/",       callback: function() { $("#search-query").focus(); return false; } },
    { title: "Create Tag",          keys: "a t",     callback: function() { Mailpile.UI.Modals.TagAdd(); }},
    { title: "Compose email",       keys: "c",       callback: function() { Mailpile.activities.compose(); }},
    { title: "Go to Inbox",         keys: "g i",     callback: function() { Mailpile.go("/in/inbox/"); }},
    { title: "Go to Drafts",        keys: "g d",     callback: function() { Mailpile.go("/in/drafts/"); }},
    { title: "View settings",       keys: "g s",     callback: function() { Mailpile.go("/settings/profiles/"); }},
    { title: "Open thread",         keys: "enter",   callback: function() { Mailpile.open_selected_thread(); }},
    { title: "Archive mails",       keys: "e",       callback: function() { Mailpile.keybinding_move_message(''); }},
    { title: "Delete mails",        keys: "#",       callback: function() { Mailpile.keybinding_move_message('trash'); }},
    { title: "Move to spam",        keys: "!",       callback: function() { Mailpile.keybinding_move_message('spam'); }},
    { title: "Move selection down", keys: "j",       callback: function() { Mailpile.bulk_action_selection_down(); }},
    { title: "Move selection up",   keys: "k",       callback: function() { Mailpile.bulk_action_selection_up(); }},
    { title: "Mark as read",        keys: "shift+i", callback: function() { Mailpile.bulk_action_read(); }},
    { title: "Mark as unread",      keys: "shift+u", callback: function() { Mailpile.bulk_action_unread(); }},
  {% if is_dev_version() %}
    // TODO: Those bindings may not work or link to pages that are WIP
    { title: "Create Contact",   keys: "a c",   callback: function() { Mailpile.UI.Modals.ContactAdd(); }},
    { title: "View tags",        keys: "g t",   callback: function() { Mailpile.go("/tags/"); }},
    { title: "Add tag",          keys: "g n t", callback: function() { Mailpile.go("/tags/add/"); }},
    { title: "View contacts",    keys: "g c",   callback: function() { Mailpile.go("/contacts/"); }},
    { title: "Add contact",      keys: "g n c", callback: function() { Mailpile.go("/contacts/add/"); }},
    { title: "Select all",       keys: "* a",   callback: function() { Mailpile.bulk_action_select_all(); }},
    { title: "Deselect all",     keys: "* n",   callback: function() { Mailpile.bulk_action_select_none(); }},
    { title: "Invert selection", keys: "* i",   callback: function() { Mailpile.bulk_action_select_invert(); }},
  {% endif %}
  ],
