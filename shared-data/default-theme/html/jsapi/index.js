...
Mailpile = {
  ...
  keybindings:        [ {#
    ...
    { title: '{{_("Create tag")|escapejs}}',          keys: "a t",     callback: function(e) { Mailpile.UI.Modals.TagAdd(); }},
    // Assign hot-keys to the contextual actions (Edit, New, Attachments, ...)
    {                                                 keys: "1",       callback: function(e) { $('#content-tools a').eq(0).trigger('click'); }},
    {                                                 keys: "2",       callback: function(e) { $('#content-tools a').eq(1).trigger('click'); }},
    {                                                 keys: "3",       callback: function(e) { $('#content-tools a').eq(2).trigger('click'); }},
    {                                                 keys: "4",       callback: function(e) { $('#content-tools a').eq(3).trigger('click'); }},
    {                                                 keys: "5",       callback: function(e) { $('#content-tools a').eq(4).trigger('click'); }},
    {                                                 keys: "6",       callback: function(e) { $('#content-tools a').eq(5).trigger('click'); }},
    {                                                 keys: "7",       callback: function(e) { $('#content-tools a').eq(6).trigger('click'); }},
    {                                                 keys: "8",       callback: function(e) { $('#content-tools a').eq(7).trigger('click'); }},
    {                                                 keys: "9",       callback: function(e) { $('#content-tools a').eq(8).trigger('click'); }},
