...
Mailpile.UI.Sidebar.events = {
  'click .button-sidebar-edit':   'Edit',
  'click .sidebar-tag-archive':   'ArchiveTag',
};

Mailpile.UI.Sidebar.init = function() {
...
Mailpile.UI.Sidebar.Draggable = function() {
...
Mailpile.UI.Sidebar.Droppable = function() {
...
Mailpile.UI.Sidebar.ToggleSubtags = function(tid, state) {
...
Mailpile.UI.Sidebar.Edit = function() {
...
Mailpile.UI.Sidebar.ArchiveTag = function(e) {
  e.preventDefault();
