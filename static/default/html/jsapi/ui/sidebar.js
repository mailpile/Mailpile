Mailpile.UI.Sidebar.SubtagsToggle = function(tid) {
  ...
  if (_.indexOf(Mailpile.config.web.subtags_collapsed, tid) > -1) {
    ...
    $('#sidebar-tag-' + tid).find('a.sidebar-tag span.sidebar-tag-expand span').removeClass('icon-expand').addClass('icon-collapse');
    ...
    $('#sidebar-tag-' + tid).find('a.sidebar-tag span.sidebar-tag-expand span').removeClass('icon-collapse').addClass('icon-expand');
